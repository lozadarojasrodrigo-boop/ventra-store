...
import { StoreForgotPasswordPanel } from '@/app/components/StoreForgotPasswordPanel'
        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
          <article className="store-panel rounded-[30px] p-7">
            ...
            <p className="mt-4 max-w-[36rem] text-[0.98rem] leading-8 text-[#424245]">
              Enviaremos un enlace a tu correo para que puedas actualizar tu contraseña y volver a entrar a tu cuenta.
            </p>
          </article>

          <StoreForgotPasswordPanel />
        </div>
      </section>
